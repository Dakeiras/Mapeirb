        ...
        try {
            ...
            for (int i = 0; i < defibrillatorArray.length(); i++) {
                ...
                LatLng position = new LatLng(
                        defibrillatorObject.optDouble(LONGITUDE, 0),
                        defibrillatorObject.optDouble(LATITUDE, 0)
                );
                ...
                poiCollectionDefibrillator.addPOIDTO(new POIDefibrillatorDTO(position, typologie, address, name, phone, installe));
            }
